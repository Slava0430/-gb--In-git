...
## Часть 1. Все что нужно знать про каталог git

Начало использование Git напоминает посещение новой страницы, языка которой вы не знаете.

### Папка.git 
Когда вы создаете новый репизиторий команда гит инит создает волшебную палку
...
1. Первый элемент это то что всегда нужно знать
2. Zdes doljno bit izmeneniya
