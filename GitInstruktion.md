...
1. git clone <адрес> - команда для клонирования репозитория с удаленного сервена на локальную машину \
    -- это команда в Git, которая создаёт на вашем компьютере точную копию удалённого репозитория.
2. git pull - Эта команда позволяет скачать все из текущего репозитория и автоматически сделать merge с нашей версией \
    -- это команда в Git, которая используется для извлечения и загрузки содержимого из удаленного репозитория и немедленного обновления локального репозитория этим содержимым.
3. git push - Эта команда позволяет отправить нашу версию репозитория на внешний репозиторий. ТРЕБУЕТ АВТОРИЗАЦИИ на внешнем репозитории \
    -- это команда для управления удаленными репозиториями. Она необходима, когда нужно поделиться изменениями с другими участниками проекта или сохранить их в центральном репозитории.
